...
scatter_plots = cowplot::plot_grid(dndmi_ndvi, dndmi_fwi, dndmi_elevation, ndvi_fwi, ndvi_elevation, fwi_elevation, 
    ...
    draw_label("r = -0.02", x = .66, y = .77, size = 10, fontface = "italic") +
    draw_label("r = 0.08", x = .42, y = .45, size = 10, fontface = "italic") +
    draw_label("r = 0.05", x = .66, y = .45, size = 10, fontface = "italic") +
    draw_label("r = 0.21", x = .42, y = .12, size = 10, fontface = "italic") +
    draw_label("r = 0.04", x = .90, y = .12, size = 10, fontface = "italic") 
