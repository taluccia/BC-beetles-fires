...
# Data
```{r}
data90 = read.csv("../data/ValidationNoNdvi/data90.csv", header=TRUE, sep = ",", strip.white = TRUE)
```

```{r}
data1 = read.csv("../data/ValidationNoNdvi/df1.csv", header=TRUE, sep = ",", strip.white = TRUE)
data2 = read.csv("../data/ValidationNoNdvi/df2.csv", header=TRUE, sep = ",", strip.white = TRUE)
data3 = read.csv("../data/ValidationNoNdvi/df3.csv", header=TRUE, sep = ",", strip.white = TRUE)
data4 = read.csv("../data/ValidationNoNdvi/df4.csv", header=TRUE, sep = ",", strip.white = TRUE)
data5 = read.csv("../data/ValidationNoNdvi/df5.csv", header=TRUE, sep = ",", strip.white = TRUE)
data6 = read.csv("../data/ValidationNoNdvi/df6.csv", header=TRUE, sep = ",", strip.white = TRUE)
data7 = read.csv("../data/ValidationNoNdvi/df7.csv", header=TRUE, sep = ",", strip.white = TRUE)
data8 = read.csv("../data/ValidationNoNdvi/df8.csv", header=TRUE, sep = ",", strip.white = TRUE)
data9 = read.csv("../data/ValidationNoNdvi/df9.csv", header=TRUE, sep = ",", strip.white = TRUE)
data10 = read.csv("../data/ValidationNoNdvi/df10.csv", header=TRUE, sep = ",", strip.white = TRUE)
...
```{r}
save(brt.model90, file = "../outputs/ValidationModelsNoNdvi/BRT90_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT90_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT90_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model90)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT90_fits.pdf")
dev.off()
```
...
write.csv(brt.model90.sum, '../outputs/ValidationModelsNoNdvi/BRT90_sum.csv', row.names = F)
brt.model90.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model90.relinf, '../outputs/ValidationModelsNoNdvi/BRT90_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model1, file = "../outputs/ValidationModelsNoNdvi/BRT1_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT1_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT1_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model1)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT1_fits.pdf")
dev.off()
```
...
write.csv(brt.model1.sum, '../outputs/ValidationModelsNoNdvi/BRT1_sum.csv', row.names = F)
brt.model1.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model1.relinf, '../outputs/ValidationModelsNoNdvi/BRT1_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model2, file = "../outputs/ValidationModelsNoNdvi/BRT2_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT2_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT2_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model2)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT2_fits.pdf")
dev.off()
```
...
write.csv(brt.model2.sum, '../outputs/ValidationModelsNoNdvi/BRT2_sum.csv', row.names = F)
brt.model2.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model2.relinf, '../outputs/ValidationModelsNoNdvi/BRT2_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model3, file = "../outputs/ValidationModelsNoNdvi/BRT3_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT3_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT3_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model3)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT3_fits.pdf")
dev.off()
```
...
write.csv(brt.model3.sum, '../outputs/ValidationModelsNoNdvi/BRT3_sum.csv', row.names = F)
brt.model3.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model3.relinf, '../outputs/ValidationModelsNoNdvi/BRT3_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model4, file = "../outputs/ValidationModelsNoNdvi/BRT4_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT4_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT4_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model4)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT4_fits.pdf")
dev.off()
```
...
write.csv(brt.model4.sum, '../outputs/ValidationModelsNoNdvi/BRT4_sum.csv', row.names = F)
brt.model4.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model4.relinf, '../outputs/ValidationModelsNoNdvi/BRT4_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model5, file = "../outputs/ValidationModelsNoNdvi/BRT5_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT5_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT5_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model5)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT5_fits.pdf")
dev.off()
```
...
write.csv(brt.model5.sum, '../outputs/ValidationModelsNoNdvi/BRT5_sum.csv', row.names = F)
brt.model5.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model5.relinf, '../outputs/ValidationModelsNoNdvi/BRT5_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model6, file = "../outputs/ValidationModelsNoNdvi/BRT6_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT6_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT6_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model6)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT6_fits.pdf")
dev.off()
```
...
write.csv(brt.model6.sum, '../outputs/ValidationModelsNoNdvi/BRT6_sum.csv', row.names = F)
brt.model6.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model6.relinf, '../outputs/ValidationModelsNoNdvi/BRT6_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model7, file = "../outputs/ValidationModelsNoNdvi/BRT7_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT7_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT7_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model7)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT7_fits.pdf")
dev.off()
```
...
write.csv(brt.model7.sum, '../outputs/ValidationModelsNoNdvi/BRT7_sum.csv', row.names = F)
brt.model7.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model7.relinf, '../outputs/ValidationModelsNoNdvi/BRT7_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model8, file = "../outputs/ValidationModelsNoNdvi/BRT8_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT8_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT8_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model8)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT8_fits.pdf")
dev.off()
```
...
write.csv(brt.model8.sum, '../outputs/ValidationModelsNoNdvi/BRT8_sum.csv', row.names = F)
brt.model8.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model8.relinf, '../outputs/ValidationModelsNoNdvi/BRT8_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model9, file = "../outputs/ValidationModelsNoNdvi/BRT9_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT9_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT9_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model9)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT9_fits.pdf")
dev.off()
```
...
write.csv(brt.model9.sum, '../outputs/ValidationModelsNoNdvi/BRT9_sum.csv', row.names = F)
brt.model9.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model9.relinf, '../outputs/ValidationModelsNoNdvi/BRT9_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model10, file = "../outputs/ValidationModelsNoNdvi/BRT10_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/ValidationModelsNoNdvi/BRT10_model.rda")
```
...
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT10_plots.pdf")
dev.off()
```

```{r eval=FALSE, include=FALSE}
gbm.plot.fits(brt.model10)
dev.print(pdf, "../outputs/ValidationModelsNoNdvi/BRT10_fits.pdf")
dev.off()
```
...
write.csv(brt.model10.sum, '../outputs/ValidationModelsNoNdvi/BRT10_sum.csv', row.names = F)
brt.model10.relinf=data.frame(rel.inf, vnames)
write.csv(brt.model10.relinf, '../outputs/ValidationModelsNoNdvi/BRT10_relinf.csv', row.names = F)
```
