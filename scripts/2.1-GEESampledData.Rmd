...
# Data
```{r}
endata = read.csv("../data/GEE-Sampled/2021-06-06_EnSampledValues.csv", header=TRUE, sep = ",", strip.white = TRUE)
twdata = read.csv("../data/GEE-Sampled/2021-06-06_TWSampledValues.csv", header=TRUE, sep = ",", strip.white = TRUE)
chdata = read.csv("../data/GEE-Sampled/2021-06-06_ChSampledValues.csv", header=TRUE, sep = ",", strip.white = TRUE)
```
...
set.seed(15)
train.data = df2 %>% 
  group_by(fwi_lohi, rdnbr_class, FireYr) %>%
  sample_frac(0.6)
train.data
```
