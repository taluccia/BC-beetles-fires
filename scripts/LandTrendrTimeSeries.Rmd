...
#### Graph Sourced and Fitted Data
```{r}
( chndmi1_plot = ggplot(chndmi1, aes(x = year, y = ndmi, color = line_type)) +
  geom_line(size=1) +
  scale_color_manual(values = c("#2b83ba", "#f03b20"), name="",
                         breaks=c("raw", "fit"),
                         labels=c("Source", "Fitted")) +
...
( enndmi1_plot = ggplot(enndmi1, aes(x = year, y = ndmi, color = line_type)) +
  geom_line(size=1) +
  scale_color_manual(values = c("#2b83ba", "#f03b20"), name="",
                         breaks=c("raw", "fit"),
                         labels=c("Source", "Fitted")) +
...
#### Graph Sourced and Fitted Data
```{r}
(twndmi1_plot = ggplot(twnmdi1, aes(x = year, y = ndmi, color = line_type)) +
  geom_line(size=1) +
  scale_color_manual(values = c("#2b83ba", "#f03b20"), name="",
                         breaks=c("raw", "fit"),
                         labels=c("Source", "Fitted")) +
...
(twndmi1_plot_pp = ggplot(twnmdi1, aes(x = year, y = ndmi, color = line_type)) +
  geom_line(size=1) +
  scale_color_manual(values = c("#2b83ba", "#f03b20"), name="",
                         breaks=c("raw", "fit"),
                         labels=c("Source", "Fitted")) +
...
```{r eval=FALSE, include=FALSE}
ggsave("../figs/2019-04-049_LT-TS_NDMI_ppt.jpeg", plot = twndmi1_plot_pp, width = 6, height = 4, units = c("in"), dpi=600 )
```

# NDMI Girded plots
```{r fig.height=6, fig.width=3}
legend = cowplot::get_legend(legend_lt)
(gpndmi1 = cowplot::plot_grid(enndmi1_plot, twndmi1_plot, chndmi1_plot, labels = c("A", "B", "C"), align = "hv", ncol= 1)  +
  draw_label("R10171", x = .27, y = .785, size = 10, fontface = "bold") +
  draw_label("R10252", x = .27, y = .449, size = 10, fontface = "bold") +
  draw_label("R10070", x = .27, y = .115, size = 10, fontface = "bold") +
  draw_label("Peak\n beetle", x = .625, y = .80, size = 10) +
...
(gpndmi2 = plot_grid(gpndmi1, legend, ncol=1, rel_widths = c(1, .1), rel_heights = c(1, .05)))
```
 


```{r eval=FALSE, include=FALSE}
ggsave("../figs/2019-04-04_LT-TS_NDMI.jpeg", plot = gpndmi2, width = 3, height = 6, units = c("in"), dpi=600 )
```

```{r fig.height=6, fig.width=3}
legend = cowplot::get_legend(legend_lt)
(gpndmi3 = cowplot::plot_grid(enndmi1_plot, twndmi1_plot, chndmi1_plot, labels = c("A", "B", "C"), align = "hv", ncol= 1)  +
  draw_label("Entiako", x = .29, y = .785, size = 10, fontface = "bold") +
  draw_label("Tweedsmuir", x = .33, y = .449, size = 10, fontface = "bold") +
  draw_label("Chelaslie", x = .31, y = .115, size = 10, fontface = "bold") +
  draw_label("Peak\n beetle", x = .625, y = .80, size = 10) +
  draw_label("Peak\n beetle", x = .625, y = .465, size = 10) +
  draw_label("Peak\n beetle", x = .625, y = .13, size = 10) )

(gpndmi4 = plot_grid(gpndmi3, legend, ncol=1, rel_widths = c(1, .1), rel_heights = c(1, .05)))
```


```{r eval=FALSE, include=FALSE}
ggsave("../figs/2019-04-04_LT-TS_NDMI_firename.jpeg", plot = gpndmi4, width = 3, height = 6, units = c("in"), dpi=600 )
```


```{r fig.height=6, fig.width=3}
legend = cowplot::get_legend(legend_lt)
(gpndmi5 = cowplot::plot_grid(enndmi1_plot1, twndmi1_plot1, chndmi1_plot1, labels = c("A", "B", "C"), align = "hv", ncol= 1)  +
  draw_label("Entiako", x = .29, y = .785, size = 10, fontface = "bold") +
  draw_label("Tweedsmuir", x = .33, y = .449, size = 10, fontface = "bold") +
  draw_label("Chelaslie", x = .31, y = .115, size = 10, fontface = "bold") +
  draw_label("Peak\n beetle", x = .625, y = .80, size = 10) +
...
(gpndmi6 = plot_grid(gpndmi5, legend, ncol=1, rel_widths = c(1, .1), rel_heights = c(1, .05)))
```


```{r eval=FALSE, include=FALSE}
ggsave("../figs/2019-04-15_LT-TS_NDMI_firename.jpeg", plot = gpndmi6, width = 3, height = 6, units = c("in"), dpi=600 )
```

## NDMI by Fire Event
```{r fig.height=6, fig.width=3}
legend = cowplot::get_legend(legend_lt)
(gpndmi7 = cowplot::plot_grid(enndmi1_plot1, twndmi1_plot1, chndmi1_plot1, labels = c("A", "B", "C"), align = "hv", ncol= 1)  +
  draw_label("Entiako", x = .29, y = .785, size = 10, fontface = "bold") +
  draw_label("Tweedsmuir", x = .33, y = .449, size = 10, fontface = "bold") +
  draw_label("Chelaslie", x = .31, y = .115, size = 10, fontface = "bold") )

(gpndmi8 = plot_grid(gpndmi7, legend, ncol=1, rel_widths = c(1, .1), rel_heights = c(1, .05)))
```


```{r eval=FALSE, include=FALSE}
ggsave("../figures/LandTrendrTimeSeries.tiff", plot = gpndmi8, width = 3, height = 6, units = c("in"), dpi=600 )
```
# NDMI & NBR Grided plots

```{r fig.height=6, fig.width=6}
legend = cowplot::get_legend(legend_lt)
(gpcombo1 = cowplot::plot_grid(enpico_plot, enndmi1_plot, twpico_plot, twndmi1_plot, chpico_plot, chndmi1_plot, labels = c("A", "B", "C", "D", "E", "F"), align = "hv", ncol= 2)  +
  draw_label("Entiako", x = .15, y = .785, size = 10, fontface = "bold") +
  draw_label("Tweedsmuir", x = .165, y = .449, size = 10, fontface = "bold") +
  draw_label("Chelaslie", x = .15, y = .115, size = 10, fontface = "bold") +
  draw_label("Peak\n beetle", x = .315, y = .80, size = 10) +
  draw_label("Peak\n beetle", x = .315, y = .465, size = 10) +
  draw_label("Peak\n beetle", x = .315, y = .13, size = 10) )

(gpcombo2 = plot_grid(gpcombo1, legend, ncol=1, rel_widths = c(1, .1), rel_heights = c(1, .05)))
```
