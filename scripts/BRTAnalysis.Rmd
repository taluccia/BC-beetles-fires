...
# Data
```{r}
model.data = read.csv("../data/TrainingData/TrainData1.csv", header=TRUE, sep = ",", strip.white = TRUE)
```
...
```{r}
save(brt.model1, file = "../outputs/BRTmodels1/BRT1_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/BRTmodels1/BRT1_model.rda")
```
...
dev.print(pdf, "../outputs/BRTmodels1/BRT1_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model1)
dev.print(pdf, "../outputs/BRTmodels1/BRT1_fits.pdf")
dev.off()
```
...
write.csv(BRT.model1.sum, '../outputs/BRTmodels1/BRT1_sum.csv', row.names = F)
BRT.model1.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model1.relinf, '../outputs/BRTmodels1/BRT1_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model2, file = "../outputs/BRTmodels1/BRT2_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/BRTmodels1/BRT2_model.rda")
```
...
dev.print(pdf, "../outputs/BRTmodels1/BRT2_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model2)
dev.print(pdf, "../outputs/BRTmodels1/BRT2_fits.pdf")
dev.off()
```
...
write.csv(BRT.model2.sum, '../outputs/BRTmodels1/BRT2_sum.csv', row.names = F)
BRT.model2.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model2.relinf, '../outputs/BRTmodels1/BRT2_relinf.csv', row.names = F)
```
...
```{r}
save(brt.model3, file = "../outputs/BRTmodels1/BRT3_model.rda")
```

```{r eval=FALSE, include=FALSE}
load(file = "../outputs/BRTmodels1/BRT3_model.rda")
```
...
dev.print(pdf, "../outputs/BRTmodels1/BRT3_plots.pdf")
dev.off()
```
```{r}
gbm.plot.fits(brt.model3)
dev.print(pdf, "../outputs/BRTmodels1/BRT3_fits.pdf")
dev.off()
```
...
write.csv(BRT.model3.sum, '../outputs/BRTmodels1/BRT3_sum.csv', row.names = F)
BRT.model3.relinf=data.frame(rel.inf, vnames)
write.csv(BRT.model3.relinf, '../outputs/BRTmodels1/BRT3_relinf.csv', row.names = F)
```
