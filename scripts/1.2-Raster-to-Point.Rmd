...
## Fire perimeters 
```{r}
tw_perm = st_read("../data/perimeters/TweedsTreed-100.shp", "TweedsTreed") 
```

```{r}
en_perm = st_read("../data/perimeters/EntiakoTreed-100.shp", "EntiakoTreed") 
```

```{r}
ch_perm = st_read("../data/perimeters/ChelaslieTreed-100.shp", "ChelaslieTreed") 
```
