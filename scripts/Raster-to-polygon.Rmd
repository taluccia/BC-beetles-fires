...
# Read in Shapefile
```{r}
tw_perm = readOGR("../data/perimeters-forest-only/tw_R10252_2013_Forestonly.shp", "tw_R10252_2013_Forestonly") 
```

```{r}
en_perm = readOGR("../data/perimeters-forest-only/en_R10171_2012_Forestonly.shp", "en_R10171_2012_Forestonly") 
```

```{r}
ch_perm = readOGR("../data/perimeters-forest-only/ch_R10070_2014_Forestonly.shp", "ch_R10070_2014_Forestonly") 
```
