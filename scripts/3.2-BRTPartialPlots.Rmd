...
brt.model6    | Lo          | Lo only    | Prefire, outbreak, weather, topography
...
```{r}
data = read.csv("../data/TrainingData/TrainData.csv") 
```
...
vars4
```{r}
mods4 = list(full_mod= brt.model1, hi_mod = brt.model2, lo_mod = brt.model3)
vars4 = c("dndmi", "elevation", "fwi", "ndviprefire")
names(vars4) = vars4
vars4
```
...
ggsave("../figures/PartialPlot.tiff", plot = grid_msplot, width = 6, height =5.25, units = c("in"), dpi=600 )
```
**THE END**